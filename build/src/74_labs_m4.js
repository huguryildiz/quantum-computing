/* ==========================================================================
   ...
   Every sphere here is drawn with the chapter's convention,

       (x, y, z)  ->  (x + 0.42 y,  z + 0.24 y),

   in an isotropic frame, so the great circle in the plane of the page is a
   genuine circle and every angle read inside that plane is true.
   ========================================================================== */
Object.assign(LABS, (function(){
  ...
  function frame(a){
    ...
    /* The three names sit outside the rim, where no state vector reaches. */
